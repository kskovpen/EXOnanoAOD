...
# with command line options: step3 --data --conditions 150X_dataRun3_v5 --datatier NANOAOD --era Run3_2023,run3_nanoAOD_pre142X --eventcontent NANOAOD --filein file:step2.root --fileout file:step3.root --nStreams 1 --nThreads 4 --scenario pp --no_exec --number 10 --python_filename driver/step_3_cfg_run3_2023.py --step NANO
