...
# with command line options: step3 --mc --conditions 150X_mcRun3_2023_realistic_postBPix_v1 --datatier NANOAODSIM --era Run3_2023,run3_nanoAOD_pre142X --eventcontent NANOAODSIM --filein file:step2.root --fileout file:step3.root --nStreams 1 --nThreads 4 --no_exec --number 10 --python_filename driver/step_3_cfg_run3_2023BPix_mc.py --step NANO
